...
import com.zhishangquan.server.constants.AlipayConstants;
import com.zhishangquan.server.util.Base64;
import com.zhishangquan.server.util.StreamUtil;
...
public class AlipaySignature {
    ...
    public static String rsaEncrypt(String content, String publicKey, String charset)
        ...
        try {
            ...
            byte[] data = StringUtil.isEmpty(charset) ? content.getBytes() : content
                .getBytes(charset);
            ...
            return StringUtil.isEmpty(charset) ? new String(encryptedData) : new String(
    ...
    public static String rsaDecrypt(String content, String privateKey, String charset)
        ...
        try {
            ...
            byte[] encryptedData = StringUtil.isEmpty(charset) ? Base64.decodeBase64(content
            ...
            return StringUtil.isEmpty(charset) ? new String(decryptedData) : new String(
