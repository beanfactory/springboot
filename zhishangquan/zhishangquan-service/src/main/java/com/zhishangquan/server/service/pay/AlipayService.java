...
import com.zhishangquan.server.config.AliConfig;
import com.zhishangquan.server.pay.PayParamBean;
import com.zhishangquan.server.pay.PayStatusBean;
import com.zhishangquan.server.response.pay.AlipayQueryResponse;
import com.zhishangquan.server.response.pay.AlipayQueryResponseBean;
import com.zhishangquan.server.response.pay.AlipayQueryResponseTrade;
import com.zhishangquan.server.util.AlipaySignature;
import com.zhishangquan.server.util.MD5Util;
import com.zhishangquan.server.util.WebUtils;
...
public class AlipayService {
    ...
    public String getPayUrlString(PayParamBean param) throws Exception {
        ...
        String sign = AlipaySignature.rsaSign(signContent, aliConfig.getPrivate_key(), aliConfig.getCharset());
     ...
     * @throws IOException
     */
    public PayStatusBean aliPayQuery(String orderNo) throws Exception {
        ...
        String result = WebUtils.doGet(aliConfig.getQuery_url(), map, aliConfig.getCharset());
        logger.info("支付宝订单查询返回内容：" + result);

        PayStatusBean bean = new PayStatusBean();
        String status = null;
        //对result进行处理 生成bean
        AlipayQueryResponseBean queryBean = XmlUtil.toObject(result, AlipayQueryResponseBean.class);
     ...
     * @throws JsonParseException 
     */
    public String aliPayRefund(String orderNo, String tradeNo, Integer amount) throws JsonParseException, JsonMappingException, IOException {
        Map<String, String> map = new HashMap<String, String>();
        //加入各类参数，签名，远程请求，处理返回值
    ...
    private boolean getSignVeryfy(Map<String, String> Params, String sign) {
        ...
        try {
            isSign = AlipaySignature.rsaCheckContent(preSignStr, sign, aliConfig.getPublic_key(),
    ...
    public String verifyResponse(String notify_id) {
        ...
        String veryfy_url = aliConfig.getHttps_verify_url() + "partner=" + partner + "&notify_id=" + notify_id;
    ...
    */
     ...
     */
    public String createEncodeLinkString(Map<String, String> params) throws UnsupportedEncodingException {
